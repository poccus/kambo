<?php
  ...
  try {
    ...
    while($row = $rs->fetch(PDO::FETCH_OBJ)){
      ...
      $retorno .= "<a href='#' class='btn btn-default btn-xs' title='O Paciente Chegou' id='chegouxxx' >&nbsp;<i class='glyphicon glyphicon-user'></i>&nbsp;Chegou</a> 
<a href='#' class='btn btn-success btn-xs' title='Confirmar Atendimento' id='confirmaratendimentoxxx'>&nbsp;<i class='glyphicon glyphicon-thumbs-up'></i>&nbsp;Confirmar Atendimento</a>  
<a href='#' class='btn btn-warning btn-xs' title='Remarcar' id='remarcarxxx' >&nbsp;<i class='glyphicon glyphicon-share-alt'></i>&nbsp;Remarcar</a>  
<a href='#' class='btn btn-danger btn-xs' title='Cancelar Agendamento' id='cancelarxxx' >&nbsp;<i class='glyphicon glyphicon-remove'></i>&nbsp;Cancelar</a> ";
      $retorno .= '</div></div></div>';
    }
    echo $retorno;
